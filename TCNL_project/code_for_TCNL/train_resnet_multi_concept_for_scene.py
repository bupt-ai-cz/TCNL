...
import shutil
# import wandb
from model.new_resnet import resnet_multi_concept_for_scene
...
def train(epoch: int, net: resnet_multi_concept_for_scene, train_loader, args: dict, train_loss: list, train_acc: list):
...
def val(epoch: int, net: resnet_multi_concept_for_scene, val_loader, args: dict, val_loss: list, val_acc :list):
    global best_acc
    global best_loss
    # net.eval()
    loss, correct, total = 0, 0, 0
...
if __name__ == '__main__':
    ...
    '''
    args = {
        'train_txt_path': '/home/wangzhihao/XAI/XCSGCNN/VOCdevkit/scene/train_multi_concept_new.txt',
        'val_txt_path': '/home/wangzhihao/XAI/XCSGCNN/VOCdevkit/scene/val_multi_concept_new.txt',
        'ckpt_path': '/home/wangzhihao/XAI/XCSGCNN/train/ckpt/resnet_multi_concept_for_scene',
        'visualization_path': '/home/wangzhihao/XAI/XCSGCNN/train/visualization/resnet_multi_concept_scene',
        'train_batch_size': 6,
        'val_batch_size': 6,
        'device': 'cuda:0',
        'epoch': 500,
    ...
    block_file = '/home/wangzhihao/XAI/XCSGCNN/train/model/resnet_backbone.py'
    model_file = '/home/wangzhihao/XAI/XCSGCNN/train/model/new_resnet.py'
    ...
    net = resnet_multi_concept_for_scene(args)
